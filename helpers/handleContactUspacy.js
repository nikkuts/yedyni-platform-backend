    ...
    if (!dealUspacyId) {
      ...
      if (["Курс переходу", "Граматичний курс"].includes(course.title)) {
        ...
        const templates = {
          ...
          "Граматичний курс": `
            <p>Раді вітати Вас в нашій спільноті Руху «Єдині» та дякуємо за долучення до мовної боротьби!</p>
            <p>Ваша реєстрація пройшла успішно і тепер Ви є учасником (учасницею) Граматичного курсу української мови. Відтепер ми наближаємо перемогу разом та будемо завжди поруч на Вашому шляху до рідної мови.</p>
            <p>Наступний крок: приєднатися до нашого <a target="_blank" href="${canal}">Telegram</a>-каналу (якщо вам потрібні щоденні нагадування про завдання та спілкування з модераторами) або зареєструватися одразу на навчальній <a target="_blank" href="https://platform.yedyni.org/register">платформі</a>, де ви можете працювати цілком автономно! Наші модератори вже з нетерпінням чекають на Вас!</p>
            <p>Курс розпочнеться у перший понеділок місяця, тож сплануйте свій час для продуктивної роботи.</p>
